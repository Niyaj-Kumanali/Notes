...
1. What is unit testing?
   ...
   - **If asked more:**
      - I would explain the FIRST principles (Fast, Isolated, Repeatable, Self-validating, Timely) and the test pyramid: unit tests at the base (fast, numerous), integration above, and end-to-end at the top (slow, few)
2. What is integration testing?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss how integration tests catch configuration issues that unit tests miss, and how we balanced unit vs integration coverage
3. Difference between unit and integration test.
   - **Answer:**
   ...
   - **If asked more:**
      - I would explain the test pyramid ratio: roughly 70% unit, 20% integration, 10% end-to-end
4. What is JUnit?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss JUnit 5 features: parameterized tests for multiple inputs, nested tests for organization, and dynamic tests for data-driven scenarios
5. What is Mockito?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss verify for checking method calls, argument matchers, spy for partial mocking, and `@InjectMocks` for automatic mock injection
6. What is mock?
   - **Answer:**
   ...
   - **If asked more:**
      - I would distinguish mocks from stubs: stubs provide predefined answers, mocks additionally verify that methods were called with expected parameters
7. What is stub?
   - **Answer:**
   ...
   - **If asked more:**
      - I would explain the difference: stubs focus on providing data for state testing, mocks focus on verifying interaction behavior
8. Difference between mock and spy.
   - **Answer:**
   ...
   - **If asked more:**
      - I would recommend mocks by default and spies only when necessary, as spies can have side effects from calling real methods
9. What is `@Mock`?
   - **Answer:**
   ...
   - **If asked more:**
      - I would explain how this reduces boilerplate compared to `Mockito.mock()` calls
10. What is `@InjectMocks`?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss how Mockito handles injection - constructor preferred, then setter, then field - and the importance of a single constructor
11. What is `@MockBean`?
   - **Answer:**
   ...
   - **If asked more:**
      - I would explain the difference from `@Mock`: `@MockBean` affects the Spring context (slower but necessary for Spring slice tests), while `@Mock` is for plain unit tests
12. What is `@SpringBootTest`?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss `webEnvironment = RANDOM_PORT` for real HTTP testing with TestRestTemplate and `@ActiveProfiles("test")` for test-specific configuration
13. What is `@WebMvcTest`?
   - **Answer:**
   ...
   - **If asked more:**
      - I would explain how it is faster than `@SpringBootTest` and how we used MockMvc for HTTP request assertions
14. What is Testcontainers?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss how Testcontainers improves reliability over in-memory alternatives by using real dependencies, with `@Container` and `@Testcontainers` annotations for lifecycle management
15. Why use Testcontainers?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss the tradeoff: slower (container startup) but more reliable. We ran them in CI only, not during local development for every change
16. How do you test repository layer?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss testing native queries and `@Query` annotations with parameter binding and projection interfaces
17. How do you test service layer?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss testing happy path, validation failures, resource not found, concurrent modifications, and keeping tests independent and fast
18. How do you test controller layer?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss testing response status codes, headers, JSON structure, and security filters (JWT, role-based access)
19. How do you test Kafka consumer?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss testing deserialization errors, poison pills, offset commit behavior, and consumer retry logic
20. How do you test scheduled jobs?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss avoiding testing the scheduler framework itself and focusing on the logic being idempotent and handling failures gracefully
21. How do you test security rules?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss testing method-level security (`@PreAuthorize`) and CSRF protection
22. What is code coverage?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss that high coverage does not guarantee good tests - we focused on branch coverage for business logic rather than line coverage numbers
23. Is 100% coverage always good?
   - **Answer:**
   ...
   - **If asked more:**
      - I would explain that mutation testing is a stronger measure than line coverage: it checks if tests actually catch bugs when the code is mutated
24. What is regression testing?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss how automated regression testing reduces the fear of making changes, especially for critical paths like inventory validation where a regression could cause financial discrepancies
25. What is smoke testing?
   - **Answer:**
   ...
   - **If asked more:**
      - I would explain that smoke tests catch obvious failures early (wrong config, missing dependencies) and prevent wasting time on deeper testing of a broken system
26. What is API testing?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss testing valid requests (200), invalid input (400), unauthorized (401/403), not found (404), and edge cases like empty responses and large payloads
27. What is Postman?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss how collections were version-controlled in the repo and used for QA testing and CI via Newman
28. How do you test error cases?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss testing both client errors (4xx) and server errors (5xx), including database failures (mocked exceptions) and timeout scenarios
29. How do you test performance changes?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss consistent test conditions (same data, server load, warm caches) and tools like JMeter for load testing
30. How do you validate database optimization results?
   - **Answer:**
   ...
   - **If asked more:**
      - I would discuss testing with production-like data volumes, validating correctness by comparing output, and monitoring optimized procedures in production for at least one reporting cycle
