# Interview Mastery Progress Tracker

## Global Rules
- Expand 1 to 2 files at a time to prevent context limits.
- Never move to a new file until the current one is fully enriched.
- Enrich one file at a time, completely, before moving to the next.
- After finishing a file, briefly state which sections were expanded and which were complete.

## Status Legend
- ⬜ Pending — not yet enriched
- 🔄 In Progress — currently being enriched
- ✅ Complete — fully enriched per instructions
